...
#####
sheep50wolves200<- read.csv(file="./IS_analysis/additional_data/sheep50wolves200.csv", stringsAsFactors = FALSE)
...
############
sheepWolves_deq <-read.csv(file="./IS_analysis/additional_data/wolvesSheep_difEQdata.csv", stringsAsFactors = FALSE)
...
ggsave("./IS_analysis/figs/viz_deq.pdf", viz_deq, width=5.75, height=4, units="in")

```

## bravo model run 
```{r}
bravo_data<- read.csv("./IS_analysis/additional_data/bravo_modelRun.csv", stringsAsFactors = FALSE)[1:200,]%>%mutate(TotalBM=TotalBM/TotalBM[1])
...
ggsave("./IS_analysis/figs/viz_bravo.pdf", viz_bravo, width=5.75, height=4, units="in")
...
ggsave("./IS_analysis/figs/viz_baseVallino.pdf", viz_baseVallino, width=4, height=2.5, units="in")
```
...
ggsave("./IS_analysis/figs/viz_vallinoRTboxplot.pdf", viz_vallinoRTboxplot, width=4, height=2.5, units="in")
...
ggsave("./IS_analysis/figs/viz_vallinoEnf.pdf", viz_vallinoEnf, width=4, height=2.5, units="in")
...
ggsave("./IS_analysis/figs/viz_vallinoKf.pdf", viz_vallinoKf, width=5.75, height=3, units="in")
...
ggsave("./IS_analysis/figs/viz_abm_lv.pdf", viz_abm_lv, width = 5.75, height = 5, units="in")
...
ggsave("./IS_analysis/figs/viz_abm_lv.pdf", viz_abm_lv, width = 5.75, height = 2.7, units="in")
```
...
```{r}
load("./IS_analysis/additional_data/cheatProb_distribution.RData")
...
ggsave("./IS_analysis/figs/viz_monSanc.pdf", viz_monSanc, width=5.75, height=3.5, units="in")
...
ggsave("./IS_analysis/figs/viz_baseMymod.pdf", viz_baseMymod, width=4, height=2.5, units="in")
...
ggsave("./IS_analysis/figs/viz_kBM_base.pdf", kBM_base_plot, width=4.5, height=2.5, units="in")
ggsave("./IS_analysis/figs/viz_kBM_allData.pdf", kBM_allData_plot, width=5, height=2.5, units="in")
...
ggsave("./IS_analysis/figs/viz_rtBoxplot.pdf", rt_boxplot, width=4, height=2.5, units="in")
```
...
ggsave("./IS_analysis/figs/viz_rtJump.pdf", viz_rt_jump, width=5.75, height=3, units="in")
...
ggsave("./IS_analysis/figs/viz_cheatK_cor.pdf", viz_cheatK_cor, width=4, height=2.5, units="in")
...
ggsave("./IS_analysis/figs/viz_jumpsAll.pdf", viz_jumpsAll, width = 5, height = 5, units = "in")
...
ggsave("./IS_analysis/figs/viz_monSanc_boxplots.pdf", viz_monSanc, width = 5.75, height = 4.4, units = "in")
